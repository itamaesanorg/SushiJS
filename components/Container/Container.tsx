...
export default function Container(props: any) {
  ...
  const meta = {
    title: '🍣 SushiJS Framework by ITAMAESAN ORG, 🍣JS',
    description:
      '🍣 SushiJS is a NextJS, TypeScript, TailwindCSS, Prisma and Motion Framer Ultimate Framework, 🍣JS',
    image: '',
    type: 'website',
    ...customMeta,
  }
    ...
    <>
      ...
      >
        <Head>
          ...
          <meta property='og:site_name' content='ITAMAESAN ORG' />
