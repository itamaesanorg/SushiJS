...
import Izakaya from 'src/common/components/elements/01 Head/05 ToggleDarkModeButton'
  ...
  return (
    <div className='hidden xl:inline'>
      ...
      >
        ...
        <div className='flex flex-row items-center space-x-4'>
          <a
            href='https://github.com/itamaesanorg/how-to-nextjs'
            className='visible'
            target='_blank'
            rel='noreferrer'
          >
        ...
        <div className='flex flex-row items-center space-x-4'>
          <a
            href='https://npmjs.com/~itamaesanorg'
            className='visible'
            target='_blank'
            rel='noreferrer'
          >
        ...
        <div className='flex flex-row items-center space-x-4'>
          ...
          >
            <svg
              ...
              height='18'
              viewBox='0 0 24 24'
              className='fill-white dark:text-white dark:text-opacity-40 dark:hover:text-opacity-100 text-gray-900 text-opacity-40 hover:text-opacity-100 transition-all duration-500 '
            >
